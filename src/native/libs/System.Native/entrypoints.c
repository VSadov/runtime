...
static const Entry s_sysNative[] =
{
    ...
    DllImportEntry(SystemNative_NativeSemaphore_Create)
    DllImportEntry(SystemNative_NativeSemaphore_Destroy)
    DllImportEntry(SystemNative_NativeSemaphore_Wait)
    DllImportEntry(SystemNative_NativeSemaphore_TimedWait)
    DllImportEntry(SystemNative_NativeSemaphore_Release)
