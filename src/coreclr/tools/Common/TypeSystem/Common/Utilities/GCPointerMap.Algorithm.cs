...
namespace Internal.TypeSystem
{
    public partial struct GCPointerMap
    {
        ...
        public static GCPointerMap FromInlinedThreadStatics(Dictionary<MetadataType, int> inlinedThreadStativBases, int threadStaticSize, int pointerSize)
        {
            GCPointerMapBuilder builder = new GCPointerMapBuilder(threadStaticSize, pointerSize);
            foreach(var typeAndOffset in inlinedThreadStativBases)
            {
                MapThreadStaticsForType(builder, typeAndOffset.Key, typeAndOffset.Value);
            }
