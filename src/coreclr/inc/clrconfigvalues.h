...
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_GCStress, W("GCStress"), 4, "Trigger GCs at regular intervals")
CONFIG_DWORD_INFO(INTERNAL_GcStressOnDirectCalls, W("GcStressOnDirectCalls"), 1, "Whether to trigger a GC on direct calls")
