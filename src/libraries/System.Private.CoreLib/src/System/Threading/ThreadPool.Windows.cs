...
#pragma warning restore CA1823
        ...
        /// Therefore make sure that the item that has been added to the queue is visible before
        /// calling this.
        /// Typically this is not a problem when enqueing uses an inerlocked operation which
        /// indicates the presence of the new item. More care may needed when an item is
        /// inserted via ordinary or volatile writes.
        /// </summary>
