        ...
        internal sealed class WorkStealingQueue
        {
            ...
            public void LocalPush(object obj)
            {
                ...
                if (tail < m_headIndex + m_mask)
                {
                    ...
                    // This write makes the slot "appear" in the queue,
                    // it happens after the write of the item, since m_tailIndex is volatile.
                ...
                // make sure the check happens after the new slot is officially in the queue.
