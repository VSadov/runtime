...
static const Entry s_cryptoNative[] =
{
    ...
    DllImportEntry(CryptoNative_CryptoNative_BioTell)
    ...
    DllImportEntry(CryptoNative_CryptoNative_DecodeOcspResponse)
    ...
    DllImportEntry(CryptoNative_CryptoNative_EcDsaSize)
    ...
    DllImportEntry(CryptoNative_CryptoNative_EcKeyCreateByOid)
    DllImportEntry(CryptoNative_EcKeyDestroy)
    DllImportEntry(CryptoNative_EcKeyGenerateKey)
    DllImportEntry(CryptoNative_CryptoNative_EcKeyGetCurveName)
    DllImportEntry(CryptoNative_CryptoNative_EcKeyGetSize)
    ...
    DllImportEntry(CryptoNative_CryptoNative_EvpCipherSetCcmNonceLength)
    DllImportEntry(CryptoNative_EvpCipherSetCcmTag)
    DllImportEntry(CryptoNative_CryptoNative_EvpCipherSetGcmNonceLength)
    ...
    DllImportEntry(CryptoNative_CryptoNative_GetECCurveParameters)
    DllImportEntry(CryptoNative_CryptoNative_GetECKeyParameters)
    DllImportEntry(CryptoNative_GetMaxMdSize)
    DllImportEntry(CryptoNative_GetMemoryBioSize)
    DllImportEntry(CryptoNative_CryptoNative_GetObjectDefinitionByName)
    ...
    DllImportEntry(CryptoNative_CryptoNative_GetRandomBytes)
    ...
    DllImportEntry(CryptoNative_GetX509NameStackField_private)
    ...
    DllImportEntry(CryptoNative_GetX509RootStoreFile_private)
    DllImportEntry(CryptoNative_GetX509RootStorePath_private)
    ...
    DllImportEntry(CryptoNative_CryptoNative_X509ChainBuildOcspRequest)
    DllImportEntry(CryptoNative_CryptoNative_X509ChainGetCachedOcspStatus)
    DllImportEntry(CryptoNative_CryptoNative_X509ChainNew)
    DllImportEntry(CryptoNative_CryptoNative_X509ChainVerifyOcsp)
    ...
    DllImportEntry(CryptoNative_CryptoNative_X509FindExtensionData)
    ...
    DllImportEntry(CryptoNative_X509GetSerialNumber_private)
    DllImportEntry(CryptoNative_X509GetSubjectName)
    DllImportEntry(CryptoNative_X509IssuerNameHash)
    DllImportEntry(CryptoNative_CryptoNative_X509StackAddDirectoryStore)
    DllImportEntry(CryptoNative_CryptoNative_X509StackAddMultiple)
    DllImportEntry(CryptoNative_X509StoreAddCrl)
    DllImportEntry(CryptoNative_CryptoNative_X509StoreCtxCommitToChain)
    ...
    DllImportEntry(CryptoNative_X509StoreCtxGetSharedUntrusted_private)
    DllImportEntry(CryptoNative_X509StoreCtxInit)
    DllImportEntry(CryptoNative_CryptoNative_X509StoreCtxRebuildChain)
    DllImportEntry(CryptoNative_CryptoNative_X509StoreCtxReset)
    DllImportEntry(CryptoNative_CryptoNative_X509StoreCtxResetForSignatureError)
    DllImportEntry(CryptoNative_X509StoreCtxSetVerifyCallback)
    DllImportEntry(CryptoNative_X509StoreDestory)
    DllImportEntry(CryptoNative_CryptoNative_X509StoreSetRevocationFlag)
    DllImportEntry(CryptoNative_CryptoNative_X509StoreSetVerifyTime)
    DllImportEntry(CryptoNative_X509UpRef)
    DllImportEntry(CryptoNative_X509V3ExtPrint)
    DllImportEntry(CryptoNative_CryptoNative_X509VerifyCert)
    ...
    DllImportEntry(CryptoNative_SslGetClientCAList_private)
